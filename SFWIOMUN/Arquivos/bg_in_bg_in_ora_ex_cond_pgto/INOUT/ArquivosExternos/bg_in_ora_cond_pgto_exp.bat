...
sqlplus -s /nolog @INTERFACES\EBS_PROCESSA_INTERFACE_ENTRADA.SQL %1 %2 %3 %4 1000 88 1
sqlplus -s /nolog @INTERFACES\EBS_PROCESSA_INTERFACE_ENTRADA.SQL %1 %2 %3 %4 1000 89 1
